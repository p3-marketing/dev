...
add_filter( 'hybrid_attr_sidebar', 'stargazer_sidebar_ssubsidiary_class', 10, 2 );
add_filter( 'hybrid_attr_sidebar', 'stargazer_sidebar_sssubsidiary_class', 10, 2 );
...
function stargazer_register_sidebars() {
	...
	hybrid_register_sidebar(
		array(
			'id'          => 'ssubsidiary',
			'name'        => _x( 'SSubsidiary', 'sidebar', 'stargazer' ),
			'description' => __( 'A ssidebar located in the footer of the site. Optimized for one, two, or three widgets (and multiples thereof).', 'stargazer' )
		)
	);
	hybrid_register_sidebar(
		array(
			'id'          => 'sssubsidiary',
			'name'        => _x( 'SSSubsidiary', 'sidebar', 'stargazer' ),
			'description' => __( 'A ssidebar located in the footer of the site. Optimized for one, two, or three widgets (and multiples thereof).', 'stargazer' )
		)
	);
...
function stargazer_sidebar_ssubsidiary_class( $attr, $context ) {

	if ( 'ssubsidiary' === $context ) {
		global $sidebars_widgets;
...
function stargazer_sidebar_sssubsidiary_class( $attr, $context ) {

	if ( 'sssubsidiary' === $context ) {
		global $sidebars_widgets;
